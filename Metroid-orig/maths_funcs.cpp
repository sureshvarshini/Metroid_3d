...
mat4 moveX(const mat4& v, float amount)
{
	mat4 trans = translate(
		identity_mat4(),
		vec3(amount, 0.0f, 0.0f)
	);
	return trans * v;

}
mat4 moveY(const mat4& v, float amount)
{
	mat4 trans = translate(
		identity_mat4(),
		vec3(0.0f, amount, 0.0f)
	);
	return trans * v;
}
mat4 moveZ(const mat4& v, float amount)
{
	mat4 trans = translate(
		identity_mat4(),
		vec3(0.0f, 0.0f, amount)
	);
	return trans * v;
}
